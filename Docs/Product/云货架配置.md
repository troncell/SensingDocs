...
<!--回主页按钮-->
  ...
  <GuessLike>
   ...
   <!--搜索面板右侧的功能按钮，可切换到不同的功能页面-->
   <UIElements>
       <!--营业员相关的功能-->
       <UIElement Id="StaffButton" Left="420" Top="320" Width="660" Height="671" IsShow="False" GroupIndex="2" />
       <!--分类相关的功能-->
       <UIElement Id="CateButton" Left="420" Top="320" Width="660" Height="671" IsShow="False" GroupIndex="2" />
       <!--键盘模糊搜索相关的功能-->
       <UIElement Id="SearchButton" Left="420" Top="320" Width="660" Height="671" IsShow="True" GroupIndex="2" />
       <!--二维码相关的功能，比如领卷等-->
       <UIElement Id="QrcodeButton" Left="420" Top="320" Width="660" Height="671" IsShow="False" GroupIndex="2" />
       <!--功能区域关闭按钮，如上面的功能有一个开启，这个按钮就需要打开-->
       <UIElement Id="CloseButton" Left="420" Top="320" Width="660" Height="671" IsShow="True" GroupIndex="2" />
     </UIElements>
</Page>
