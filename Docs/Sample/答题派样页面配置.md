...
打开h5games\projects\2023\paiyangji\paiyangji_m\assets\js

!["H5images"](https://sensingstore.oss-cn-shanghai.aliyuncs.com/Troncell/Knowledge/Docs/Sample/images/H5images/11.png)

## 3.2运行

1. 在vscode里安装live server

!["H5images"](https://sensingstore.oss-cn-shanghai.aliyuncs.com/Troncell/Knowledge/Docs/Sample/images/H5images/12.png)

2.单击paiyangji\_m文件夹下的paiyangji-m.html，打开后右击选择open with live sever

!["H5images"](https://sensingstore.oss-cn-shanghai.aliyuncs.com/Troncell/Knowledge/Docs/Sample/images/H5images/13.png)
...
打开h5games\projects\2023\paiyangji\paiyangji_m\assets\imgs
...
!["H5images"](https://sensingstore.oss-cn-shanghai.aliyuncs.com/Troncell/Knowledge/Docs/Sample/images/H5images/15.png)

3. 创建后将修改的文件包里dist和paiyangji\_m文件夹放在新建的文件夹下

!["H5images"](https://sensingstore.oss-cn-shanghai.aliyuncs.com/Troncell/Knowledge/Docs/Sample/images/H5images/16.png)
