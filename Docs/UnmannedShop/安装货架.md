...
勾选Debug
   ...
   <img style="width:400px" class="right" src="./images/Huojia/1.jpg" alt="images" />

3.点击保存后，退出进程重新打开

4.页面展示
 <img style="width:500px" class="right" src="./images/Huojia/2.png" alt="images" />
...
拿起（或放下下）商品前该货道的重量，拿起（或放下）商品后货道的重量，同时会有重量变化的事件发送
 ...
 <img style="width:500px" class="right" src="./images/Huojia/3.png" alt="images" />