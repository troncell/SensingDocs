...
\项目信息文件 NAS 地址：\\192.168.3.8\实施交付\2025年项目交付备份\2025.8.29江森电气测试小车
...
| --------------------------------- | ---------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| 上位机                            | net core9.0<br />Wpf<br />C# | 提供工位的检测界面及功能 | 1.Windows10 及以上操作系统<br />2.8 核 CPU，内存 16G 以上，存储 500G                                                                                                           | 部署在小车上面，ip：10.90.90.231<br />PLC  ip：192.168.0.1（小车以太网需要更改 IP 为 192.168.0.x） |
| 数据库                            | SQL                          | 存储检测数据             | 1.SQL Server 2016 及以上<br />2.硬件要求:4 核 CPU，内存 16G 或以上，存储 500G<br />3.江森数据库：c-wuxvm31                                                                     | 数据库是：WXAC_TroncellTestHub                                                                     |
